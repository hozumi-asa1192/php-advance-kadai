            ...
            <div class="books-ui">
                <div>
                    <a href="read.php?order=desc&keyword=<?=$keyword?>">
                        <img src="image\desc.png" alt="降順に並べ替え" class="sort-img">
                    </a>
                    <a href="read.php?order=asc&keyword=<?=$keyword?>">
                        <img src="image\asc.png" alt="昇順に並べ替え" class="sort-img">
                    </a>
                    <form action="read.php" method="get" class="seach-form">
            ...
            <table class="books-table">
                ...
                foreach($books as $book){
                   ...
                   <tr>
                    ...
                    <td><a href='update.php?id={$book['id']}'><img src='image/edit.png' alt='編集' class='edit-icon'></a></td>
                    <td><a href='delete.php?id={$book['id']}'><img src='image/delete.png' alt='削除' class='delete-icon'></a></td>
                   </tr>";
