    ...
    <main>
        <article class="registration">
            ...
            <div>
                ...
                <input type="number" name="book_code" id="book_cade" min="0" max="100000000" require>

                <label for="book_name">書籍名</label>
                <input type="text" name="book_name" id="book_name" maxlength="50" require>

                <label for="price">値段</label>
                <input type="number" name="price" id="price" min="0" max="100000000" require>

                <label for="stock_quantity">在庫数</label>
                <input type="number" name="stock_quantity" id="stock_quantity" min="0" max="100000000" require>
